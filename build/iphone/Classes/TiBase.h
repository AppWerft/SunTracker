...
// in simulator we redefine to format for SunTracker Developer console
...
{\
	NSString * exceptionName = [@"org.suntracker." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.suntracker";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISunTrackerNativeItemNone = -1, 
	UISunTrackerNativeItemSpinner = -2,
	UISunTrackerNativeItemProgressBar = -3,
	
	UISunTrackerNativeItemSlider = -4,
	UISunTrackerNativeItemSwitch = -5,
	UISunTrackerNativeItemMultiButton = -6,
	UISunTrackerNativeItemSegmented = -7,
	
	UISunTrackerNativeItemTextView = -8,
	UISunTrackerNativeItemTextField = -9,
	UISunTrackerNativeItemSearchBar = -10,
	
	UISunTrackerNativeItemPicker = -11,
	UISunTrackerNativeItemDatePicker = -12,
	
	UISunTrackerNativeItemInfoLight = -13,
	UISunTrackerNativeItemInfoDark = -14,
	
	UISunTrackerNativeItemDisclosure = -15,
	
	UISunTrackerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SunTracker instances of
