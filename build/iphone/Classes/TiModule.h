...
/**
 The base class for all SunTracker modules
 */
...
/**
 SunTracker Platform calls this method on startup.
 */
-(void)startup;

/**
 SunTracker Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 SunTracker Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 SunTracker Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 SunTracker Platform calls this method on resume.
 @param sender The sender of the event.
 */
