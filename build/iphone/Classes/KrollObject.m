 ...
 * Copyright (c) 2009-2011 by SunTracker, Inc. All Rights Reserved.
...
//@interface SunTrackerObject : NSObject
//@end

@interface SunTrackerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SunTrackerObject class]])
		{
			for (NSString *key in [[(SunTrackerObject*)o modules] allKeys])
			{
