...
@interface SunTrackerObject : KrollCoverageObject {
#else
@interface SunTrackerObject : KrollObject {
#endif
@private
...
extern NSString * SunTracker$ModuleRequireFormat;
