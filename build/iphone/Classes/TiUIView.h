...
/**
 Base class for all SunTracker views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SunTracker view hierarchy (such as wrapped iOS UIViews) was touched.
